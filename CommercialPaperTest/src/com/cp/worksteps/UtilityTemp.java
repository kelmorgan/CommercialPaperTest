...
public class UtilityTemp extends Shared implements IFormServerEventHandler , Constants {
    private static final Logger logger = LogGenerator.getLoggerInstance(UtilityTemp.class);
    @Override
